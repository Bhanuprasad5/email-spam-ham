...
model = pickle.load(open(r"C:\Users\chouk\Streamlit\email_spam_ham\email spam ham.pkl","rb"))
tf = pickle.load(open(r"C:\Users\chouk\Streamlit\email_spam_ham\vectorization.pkl","rb"))
